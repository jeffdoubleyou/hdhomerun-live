...
class HTTPRequestHandler {
    ...
    constructor(args) {
        ...
        scan = new Scanner({ settings: settings, Once: true, SkipScan: appConfig.SkipScan, Debug: appConfig.Debug, ExecutablePath: appConfig.ChromePath, Provider: appConfig.Provider });
    }
    ...
    Play(req, res) {
        ...
        const Channel = new ChannelModule({ settings: settings, Debug: appConfig.Debug, ExecutablePath: appConfig.ChromePath, Provider: appConfig.Provider });
    ...
    Scan(req, res) {
        if(scan.ScanInProgress) {
            consolelog("Already scanning for channels");
        }
        else {
